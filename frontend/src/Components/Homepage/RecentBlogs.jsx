...
// import Bl3 from './../../assets/StaticBlog/bl3.jpg';
import BlogCard from '../BlogCard/BlogCard';
// frontend\src\assets\StaticBlog\bl3.jpg
...
const RecentBlogs = () => {
  ...
  return (
    <div className='mb-4 py-4 mx-36'>
            {/* <h1 className='text-2xl font-semibold rounded mb-3 mx-[20px] '>Recent Insights</h1> */}
